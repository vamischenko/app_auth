...
return [
    ...
    */
    ...
    'vkontakte' => [
        ...
        'redirect' => env('VKONTAKTE_REDIRECT_URL', env('APP_URL') . '/auth/vkontakte/callback'),
    ],

    'yandex' => [
        'client_id' => env('YANDEX_CLIENT_ID'),
        'client_secret' => env('YANDEX_CLIENT_SECRET'),
        'redirect' => env('YANDEX_REDIRECT_URL', env('APP_URL') . '/auth/yandex/callback'),
    ],

    'mailru' => [
        'client_id' => env('MAILRU_CLIENT_ID'),
        'client_secret' => env('MAILRU_CLIENT_SECRET'),
        'redirect' => env('MAILRU_REDIRECT_URL', env('APP_URL') . '/auth/mailru/callback'),
    ],
